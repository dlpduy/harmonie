...
const Sidebar = (props: SidebarProps) => {
    ...
    const sidebarItems: SidebarItem[] = [
        ...
        { icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/b328b17599cad2b4a63641be83519929de0f022ca1eba692c776f32482b4e7b0?placeholderIfAbsent=true&apiKey=f0873bf2dfbf4fd991f254a2ddabbdea", text: "Thông tin cá nhân", isActive: true },
        { icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/b328b17599cad2b4a63641be83519929de0f022ca1eba692c776f32482b4e7b0?placeholderIfAbsent=true&apiKey=f0873bf2dfbf4fd991f254a2ddabbdea", text: " Thông tin giao hàng", isActive: true },
    ];
    return (
